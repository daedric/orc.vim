...
syn match orcIdentifier '\<\w\+\>' contained skipwhite
syn match orcSeq '>\w*>' contains=orcIdentifier skipwhite
syn match orcPrune '<\w*<' contains=orcIdentifier skipwhite
...
syn region orcComment start="{-" end="-}" contains=orcTodo
...
hi def link orcSeq         Operator
hi def link orcPrune       Operator
